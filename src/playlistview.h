...
public:
    explicit PlaylistView(QWidget *parent = nullptr,QVariant playlist_id = QVariant(""));
    ~PlaylistView();
...
signals:
    void downloadSelected(const QString playlistId, const QStringList itemsIdList);
