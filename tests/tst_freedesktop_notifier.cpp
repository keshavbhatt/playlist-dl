...
using pldl::platform::linux_::DBusImage;
using pldl::platform::linux_::FreedesktopNotifier;
...
namespace {
pldl::core::Notification note(const QString& title)
{
    pldl::core::Notification n;
    n.title = title;
    return n;
}
} // namespace
...
private Q_SLOTS:
    ...
    void imageDataIsRgbaByteOrder()
    {
        ...
        const DBusImage d = pldl::platform::linux_::toDBusImage(img);
        QCOMPARE(d.width, 2);
        QCOMPARE(d.height, 1);
        ...
        QCOMPARE(pldl::platform::linux_::fromDBusImage(d).pixelColor(1, 0), QColor(0, 0, 255, 128));
    }
    ...
    void notifyRoundTripAndIdFiltering()
    {
        ...
        n.body = u"hello"_s;
        n.sound = true;
        n.desktopEntry = u"com.ktechpit.red"_s;
        ...
        QCOMPARE(m_server.lastHints.value(u"category"_s).toString(), u"transfer.complete"_s);
        QCOMPARE(m_server.lastHints.value(u"desktop-entry"_s).toString(), u"com.ktechpit.red"_s);
        QCOMPARE(m_server.lastHints.value(u"sound-name"_s).toString(), u"complete-download"_s);
        ...
        QCOMPARE(pldl::platform::linux_::fromDBusImage(received).pixelColor(0, 0), QColor(Qt::green));
