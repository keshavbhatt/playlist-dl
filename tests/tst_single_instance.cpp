...
private Q_SLOTS:
    void init()
    {
        ...
        m_key = u"pldl-test-%1"_s.arg(QRandomGenerator::global()->generate());
    }
    ...
    {
        QVERIFY(pldl::app::instanceKeyFor(QString()).contains(u"default"_s));
        QVERIFY(pldl::app::instanceKeyFor(u"work"_s).contains(u"work"_s));
        QVERIFY(pldl::app::instanceKeyFor(u"work"_s) != pldl::app::instanceKeyFor(u"home"_s));
    }
